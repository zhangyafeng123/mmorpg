...
high-level features and usage of the HyperText tool.

If you wish to publish packages that depend on this one, you can do so with the
...
Please visit
http://candlelightinteractive.com/docs/uas-hypertext/html/KnownIssues.htm for a
